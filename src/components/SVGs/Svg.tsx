...
export const RandomSVGSeven = () => {
  return (
    ...
    >
      <path
        d="M20 2L11.6 10.4L8.4 5.6L2 12"
        stroke="#fff"
        strokeWidth="3"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const RandomSVGThirteen = () => {
  return (
    <svg
      className="random-icon"
      width="24"
...
export const RandomSVGFourteen = () => {
  return (
    <svg
      className="random-icon"
      width="22"
